...
const Navbar = () => {
  ...
  return (
    <div className="w-4/5 mt-5 lg:mt-8 mx-auto flex justify-between items-center relative">
        <Logo />
        ...
        <div className={`${toggleMenu ? 'block' : 'hidden'} absolute z-50 bg-home w-full top-0 lg:hidden`}>
          <div className="mt-10 flex flex-col w-4/5 mx-auto">
            ...
            <div className="flex flex-col mt-10">
                ...
                <div className="flex">   
                  <Link href='/register' 
                  className="gradient-primary px-20 rounded-sm py-5 mt-10">
                    Register
                  </Link>
                </div>
            </div>
        ...
        <div className="hidden lg:flex items-center">
            ...
            <div className="flex">   
              <Link href='/register' 
              className="gradient-primary px-10 rounded-sm py-3 ml-10 transition-colors">
                    Register
               </Link>
            </div>
        </div>
